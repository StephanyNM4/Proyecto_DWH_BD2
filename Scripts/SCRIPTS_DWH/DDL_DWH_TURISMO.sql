...
CREATE TABLE tbl_servicios (
    ...
    id_servicio_aerolinea NUMBER,
    id_servicio_hotel     NUMBER,
...
CREATE TABLE tbl_servicios_x_boleto (
    id_boleto_factura NUMBER NOT NULL,
...
ALTER TABLE tbl_servicios_x_boleto
...
CREATE SEQUENCE tbl_facturas_id_factura_dwh START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tbl_facturas_id_factura_dwh BEFORE
    INSERT ON tbl_facturas
    FOR EACH ROW
    WHEN ( new.id_factura_dwh IS NULL )
BEGIN
    :new.id_factura_dwh := tbl_facturas_id_factura_dwh.nextval;
END;
/
...
CREATE SEQUENCE tbl_servicios_id_servicio_dwh START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tbl_servicios_id_servicio_dwh BEFORE
    INSERT ON tbl_servicios
    FOR EACH ROW
    WHEN ( new.id_servicio_dwh IS NULL )
BEGIN
    :new.id_servicio_dwh := tbl_servicios_id_servicio_dwh.nextval;
END;
/
