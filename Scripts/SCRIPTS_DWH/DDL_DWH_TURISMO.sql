...
ALTER TABLE tbl_favoritos_de_clientes ADD CONSTRAINT tbl_favoritos_de_clientes_pk PRIMARY KEY ( correo_cliente,
                                                                                                id_hotel );
...
ALTER TABLE tbl_servicios ADD CONSTRAINT tbl_servicios_pk PRIMARY KEY ( id_servicio );
...
ALTER TABLE tbl_evaluaciones_x_hotel
    ADD CONSTRAINT fk_evaluaciones_x_hotel_c FOREIGN KEY ( correo_cliente )
        REFERENCES tbl_clientes ( correo_electronico );

ALTER TABLE tbl_favoritos_de_clientes
    ADD CONSTRAINT fk_favoritos_cliente FOREIGN KEY ( correo_cliente )
        REFERENCES tbl_clientes ( correo_electronico );
...
ALTER TABLE tbl_reservaciones
    ADD CONSTRAINT fk_reservaciones_cliente FOREIGN KEY ( correo_cliente )
        REFERENCES tbl_clientes ( correo_electronico );
...
ALTER TABLE tbl_boletos
    ADD CONSTRAINT tbl_boletos_tbl_c_fk FOREIGN KEY ( correo_electronico )
        REFERENCES tbl_clientes ( correo_electronico );
...
ALTER TABLE tbl_carreras
    ADD CONSTRAINT tbl_ca_tbl_c_fk FOREIGN KEY ( correo_electronico )
        REFERENCES tbl_clientes ( correo_electronico );
...
ALTER TABLE tbl_conductores
    ADD CONSTRAINT tbl_co_tbl_h_u_fk FOREIGN KEY ( id_carro )
        REFERENCES tbl_historico_ubers ( id_historico );
