...
--------------------------------------------------------PRG_SP_ETL_EVALUACIONES
BEGIN
    DBMS_SCHEDULER.CREATE_PROGRAM(
        PROGRAM_NAME => 'PRG_SP_ETL_EVALUACIONES',
        PROGRAM_TYPE => 'PLSQL_BLOCK',
        PROGRAM_ACTION => 'BEGIN PKG_ETLS_HOTELES.P_ETL_EVALUACIONES; END;',
        ENABLED => TRUE,
...
--------------------------------------------------------JOB_SP_ETL_EVALUACIONES
BEGIN
    DBMS_SCHEDULER.CREATE_JOB(
        JOB_NAME => 'JOB_SP_ETL_EVALUACIONES',
        PROGRAM_NAME => 'PRG_SP_ETL_EVALUACIONES',
        SCHEDULE_NAME => 'INTERVALO_DIARIO',
        ENABLED => TRUE,
        AUTO_DROP => FALSE,
