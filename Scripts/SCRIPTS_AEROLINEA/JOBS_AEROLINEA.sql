...
BEGIN
    DBMS_SCHEDULER.CREATE_PROGRAM(
        PROGRAM_NAME => 'PRG_P_ETL_ASIENTOS',
        PROGRAM_TYPE => 'PLSQL_BLOCK',
        PROGRAM_ACTION => 'BEGIN PKG_ETLS_AEROLINEA.P_ETL_ASIENTOS; END;',
        ENABLED => TRUE,
        COMMENTS => 'PROGRAMA PARA ASIENTOS'
    );
END;
...
--------------------------------------------------------JOB_P_ETL_ASIENTOS (ANUAL)
BEGIN
    DBMS_SCHEDULER.CREATE_JOB(
        JOB_NAME => 'JOB_P_ETL_ASIENTOS',
        PROGRAM_NAME => 'PRG_P_ETL_ASIENTOS',
        SCHEDULE_NAME => 'INTERVALO_ANUAL',
        ENABLED => TRUE,
        AUTO_DROP => FALSE,
        COMMENTS => 'JOB CON INTERVALOS PARA ASIENTOS'
    );
END;
